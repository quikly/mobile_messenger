  ...
  describe "with default configuration" do
    ...
    describe "send_bulk" do
      ...
      it "#send_job_params_to_xml(params)" do
        params = @client.send(:send_bulk_params, '12345', {'6175551000' => 'message 1', '6175551001' => 'message 2'})
        ...
        expect(REXML::XPath.match(doc, '/job-request/message/sms').first.text).to be_nil
